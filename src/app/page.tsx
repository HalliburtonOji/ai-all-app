...
export default async function Home() {
  ...
  return (
    <main className="bg-hero-stage relative overflow-hidden">
      ...
      {/* THE LOOP ──────────────────────────────────────────────────── */}
      <section className="reveal-on-scroll relative border-t border-[var(--border-soft)] bg-[var(--surface)]/40 backdrop-blur">
      ...
      {/* BENTO GRID ────────────────────────────────────────────────── */}
      <section className="reveal-on-scroll relative border-t border-[var(--border-soft)]">
      ...
      <section className="reveal-on-scroll relative border-t border-[var(--border-soft)] bg-[var(--surface)]/40">
